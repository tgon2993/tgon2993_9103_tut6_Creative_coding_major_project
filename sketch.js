...
let rotationAngle = 0;
let showElements = [];
let totalElements = 25; // Total number of elements to show
...
function draw() {
  ...
  if (showElements[10]) drawRectAndCircle(centerX + 55, centerY + 1.7 * diameters[1] + diameters[2] + diameters[3], 60, 60, red, yellow, centerX + 85, centerY + 2.2 * diameters[1] + diameters[2] + diameters[3], 60);
  if (showElements[11]) drawSplitCircleLR(centerX, centerY - 0.92 * diameters[0], diameters[3], green, red);
  if (showElements[12]) drawSplitCircleLR(centerX, centerY - 1.68 * diameters[0], diameters[0], green, red);
  if (showElements[13]) drawSplitCircleLR(centerX, centerY + 1.3 * diameters[1], diameters[1], green, red);
  if (showElements[14]) drawSplitCircleLR(centerX, centerY + diameters[1] + diameters[2], diameters[2], green, red);
  ...
  if (showElements[17]) drawSplitCircleTopRed(centerX + 0.8 * diameters[1], centerY + 1.71 * diameters[1] + diameters[2] + diameters[3], diameters[3], red, green);
  if (showElements[18]) drawSplitCircleTopRed(centerX + 1.7 * diameters[1], centerY + 1.71 * diameters[1] + diameters[2] + diameters[3], diameters[0], red, green);
  if (showElements[19]) drawSplitCircleTopRed(centerX - 0.8 * diameters[1], centerY + 1.71 * diameters[1] + diameters[2] + diameters[3], diameters[3], red, green);
  ...
  if (showElements[22]) drawSplitCircleLR(centerX + 1.26 * diameters[2] + diameters[0] + diameters[3] / 2, centerY - 1.8 * diameters[0] + diameters[2] * 0.1, diameters[1], green, red);
  if (showElements[23]) drawSplitCircleLR(centerX + 1.26 * diameters[2] + diameters[0] + diameters[3] / 2, centerY - 1.48 * diameters[0] - diameters[1] + diameters[2] * 0.1, diameters[0], green, red);
  if (showElements[24]) drawSplitCircleLR(centerX + 1.26 * diameters[2] + diameters[0] + diameters[3] / 2, centerY - 0.65 * diameters[0] - diameters[1] - diameters[2] + diameters[2] * 0.1, diameters[2], green, red);
